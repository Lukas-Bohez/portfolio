...
export const metadata: Metadata = {
  ...
  description:
    'Portfolio of Lukas Bohez, full-stack web developer. Full-stack work in Python/FastAPI, TypeScript, Flutter and cross-platform development. Projects include QuizTheSpire, Convert The Spire Reborn latest release, and the Lofi browser extension.',
  icons: {
    icon: [
  ...
  openGraph: {
    title: 'Lukas Bohez | Full-Stack Developer · Flutter · Python · Next.js',
    description:
      'Portfolio of Lukas Bohez, full-stack web developer. Projects include QuizTheSpire, Convert The Spire Reborn latest release, and the Lofi browser extension.',
